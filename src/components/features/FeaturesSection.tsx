...
export const FeaturesSection = () => {
  return (
    <section className="container px-4 py-4 md:py-12">
      {/* Header Section */}
      <div className="max-w-2xl mb-8 md:mb-12">
        <h2 className="text-4xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          Layanan
          <br />
          <span className="text-gradient font-medium">Website Makassar</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-600 text-left">
          Solusi website profesional untuk berbagai kebutuhan bisnis di Makassar dengan desain modern dan SEO-friendly.
        </p>
      </div>
